...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{ asset('frontend/frontend/assets/images/favicon.png') }}" />
            ...
            <div class="row" data-aos="fade-up">
              <div class="col-xl-8 stretch-card grid-margin">
                <div class="position-relative">
                  <img
                    src="{{ asset('frontend/assets/images/dashboard/banner.jpg') }}"
                    alt="banner"
                    class="img-fluid"
                  />
                  ...
                  <div class="card-body">
                    ...
                    >
                      ...
                      <div class="rotate-img">
                        <img
                          src="frontend/assets/images/dashboard/home_1.jpg"
                          alt="thumb"
                    ...
                    >
                      ...
                      <div class="rotate-img">
                        <img
                          src="frontend/assets/images/dashboard/home_2.jpg"
                          alt="thumb"
                          class="img-fluid img-lg"
                        />
                      </div>
                    ...
                    >
                      ...
                      <div class="rotate-img">
                        <img
                          src="frontend/assets/images/dashboard/home_3.jpg"
                          alt="thumb"
                          class="img-fluid img-lg"
                        />
                      </div>
                      ...
                      <div class="col-sm-4 grid-margin">
                        <div class="position-relative">
                          ...
                          <div class="rotate-img">
                            ...
                            <img
                              src="frontend/assets/images/dashboard/home_4.jpg"
                              alt="thumb"
                              class="img-fluid"
                            />
                          </div>
